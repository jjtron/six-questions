            ...
            if (typeof selectedList !== 'undefined') {
                isCheckedArray.push(
                    <div key={i} className="flex flex-row">
                        <div className="basis-1/5 text-xs bg-green-100 border-tbl-1 border-slate-400">{selectedList[1].name}:</div>
                        <div className="basis-4/5 text-xs bg-white border-trb-1 border-slate-400">{selectedList[1].comments}</div>
                    </div>
                );
            }
        });
