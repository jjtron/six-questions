...
export default function Form() {
  ...
  return (
    <form action={dispatch} className="flex flex-col rounded-md bg-slate-200 p-4 md:p-6 md:ml-2">
        ...
        <div className={clsx("w-full max-h-[168px]", {"place-type-visible": isOpen1, "place-type-hidden": !isOpen1 })}>
      ...
      {/* COUNTRY ONLY */}
      <div className={clsx("w-full max-h-[42px]", {"place-type-visible": isOpen2, "place-type-hidden": !isOpen2 })}>
            {/* NAME OF COUNTRY */}
            <div className="flex flex-row">
                <input
                  id="country"
      ...
      {/* COUNTRY ONLY */}
      <div className={clsx("w-full max-h-[42px]", {"place-type-visible": isOpen3, "place-type-hidden": !isOpen3 })}>
            {/* NAME OF COUNTRY */}
            <div className="flex flex-row">
                <input
                  id="country"
