...
export default function MultiSelectWho(props:  {options: SelectOptions} ) {
    ...
    return (
      <div className="flex flex-row max-[431px]:flex-col" >
        <div className="max-[431px]:basis-32 basis-48 shrink-0 h-[140px] overflow-auto">
            {Object.entries(props.options).map((el, i) => {
                return (
                    <div key={i}
                        className="max-[431px]:text-xs text-base flex flex-row border-1 rounded-md hover:cursor-pointer"
