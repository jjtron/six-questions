      ...
      {activeStep === steps.length ? (
        ...
        <React.Fragment>
          ...
          <Box className="pl-2 mt-[-40px]" >
            ...
            */}
            <button onClick={handleNext} className={clsx("max-[320px]:text-xs text-base rounded-md bg-sky-200 px-2 active:bg-sky-300 border-1 border-slate-400", {"hidden" : activeStep === 1})}
