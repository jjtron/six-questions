  ...
  return (
    <main>
          ...
          <div className={`${lusitana.className} text-xl text-black md:text-xl md:leading-normal md:px-28 px-6 text-justify`} >
              ...
              <p className="mb-6">Anyone using this app is free to add content; it is only meant to demonstrate my skill
                 in creating a front end React app, with backend React Server Components (RSCs), CRUD capability, backend PostgreSQL database,
                 deployed on a Linux web server, secured by an SSL certificate (https), and protected by state-of-the art User Authentication and Session Management.
              </p>
          </div>
